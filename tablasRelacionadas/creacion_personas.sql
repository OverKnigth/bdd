...
values('1721548123', 'Juan', 'Perez', '12/08/2005');

insert into personas(cedula, nombre, apellido, fecha_nacimiento)
values('1721548799', 'Sean', 'Paul', '01/05/1985');

insert into personas(cedula, nombre, apellido, fecha_nacimiento)
values('1721548790', 'Lady', 'Gaga', '12/09/1995');

insert into personas(cedula, nombre, apellido, fecha_nacimiento)
values('1721548791', 'Jennifer', 'Lopez', '16/04/1992');

insert into personas(cedula, nombre, apellido, fecha_nacimiento)
values('1721548792', 'Jennifer', 'Aniston', '21/12/1899');
